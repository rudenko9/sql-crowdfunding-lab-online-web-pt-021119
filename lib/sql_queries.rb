...
"SELECT project.title, (SUM(pledges.amount) - projects.funding_goal) AS total amount FROM projects INNER JOIN pledges ON project.id = pledges.project id GROUP BY projects.title HAVING total_amount >= 0"
end
